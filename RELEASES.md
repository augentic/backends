...
- Updated Postgres backend to work with the wasi-sql specification
- Modified all backends to reference qwasr
...
- [0.20.x](https://github.com/augentic/backends/blob/release-0.20.0/RELEASES.md)
